   ...
   <!-- Breadcrumb Area Start -->
    ...
    <div class="section section-margin">
        ...
        <div class="accordion_area">
            <div class="container">
                <div class="row mb-n8">
                    <p class="text-black" align="justify">Free scholarship-related information is available at <a href="{{ url('/') }}" target="_blank">NFH Scholarship</a>. For accurate and up-to-date information, however, always consult the official websites of the scholarship sponsors. You do so at your own risk if you rely on any information found at <a href="{{ url('/') }}" target="_blank">NFH Scholarship</a>.</p>
                    <p class="text-black" align="justify">It should be noted that the scholarship sources listed on this page are in no way associated with <a href="{{ url('/') }}" target="_blank">NFH Scholarship</a>. This website only provides information for educational reasons.</p>
