   ...
   <!-- Breadcrumb Area Start -->
    ...
    <div class="section section-margin">
        ...
        <div class="accordion_area">
            <div class="container">
                <div class="row mb-n8">
                    <p class="text-black" align="justify">Your use of the <a href="{{ url('/') }}" target="_blank">MFH Scholarship</a> is subject to the terms and conditions listed below (the "Terms"). Before using the website, please read the Terms carefully. </p>
                     <ul>
                    ...
                    <h3>•	Terms of use</h3>
                    <p class="text-black" align="justify">The <a href="{{ url('/') }}" target="_blank">MFH Scholarship</a> offers details about scholarships, fellowships, and other possibilities for studying abroad.</p>
                    <p class="text-black" align="justify">The <a href="{{ url('/') }}" target="_blank">MFH Scholarship</a> neither manages nor administers scholarship or fellowship programs nor does it offer scholarships or fellowships. The management of any scholarship or fellowship program for which it offers information is not the responsibility of the <a href="{{ url('/') }}" target="_blank">MFH Scholarship</a>.</p>
                    <p class="text-black" align="justify">The <a href="{{ url('/') }}" target="_blank">MFH Scholarship</a> offers links to other websites that offer details on fellowships and scholarships. The <a href="{{ url('/') }}" target="_blank">MFH Scholarship</a> has no control over these external websites, and as a result, the <a href="{{ url('/') }}" target="_blank">MFH Scholarship</a> is not liable for the truthfulness, relevance, or content of the material found there.</p>
                    <p class="text-black" align="justify">The <a href="{{ url('/') }}" target="_blank">MFH Scholarship</a> neither recommends nor endorses any specific fellowship or scholarship program nor does it make any claims regarding the caliber of the offerings.</p>
                    <p class="text-black" align="justify">The <a href="{{ url('/') }}" target="_blank">MFH Scholarship</a> does not gather any personal data from website visitors. However, the <a href="{{ url('/') }}" target="_blank">MFH Scholarship</a> may gather general data on how people use the website. This data is not disclosed to outside parties and is only used to enhance the website's content.</p>
                    <p class="text-black" align="justify">You accept these terms of usage by using <a href="{{ url('/') }}" target="_blank">MFH Scholarship</a>. You shouldn't use the <a href="{{ url('/') }}" target="_blank">MFH Scholarship</a> if you disagree with these terms of usage.</p>
                     ...
                     <p class="text-black" align="justify">You and the <a href="{{ url('/') }}" target="_blank">MFH Scholarship</a> have a contract that governs the service agreement's terms. You consent to abide by the guidelines outlined in the contract. The <a href="{{ url('/') }}" target="_blank">MFH Scholarship</a> may file a lawsuit if you violate the terms.</p>
