                    ...
                    if ($countires) {
                       ...
                       $AddScholarship=AddScholarship::where('scholarship_country','=',$degreeSlug)->paginate(9);
                        ...
                        if($degreeSlug=='internships')
                        {
                           ...
                           $content='Embarking on an academic journey goes beyond the confines of the classroom. Real-world experience plays a pivotal role in molding students into industry-ready professionals. Recognizing this, MFH Scholarship has curated a comprehensive portal dedicated to the <b>Student Internship Program</b>, ensuring that aspiring minds get the practical exposure they need to excel in their respective fields.The <strong>Summer Internship</strong> section is especially buzzing with opportunities. As the season heralds a time of learning and exploration, our platform brings together a selection of internships across various sectors. These summer stints are not just about gaining work experience; they are about understanding industry dynamics, networking with professionals, and paving the path for future endeavors. With MFH Scholarship by your side, your quest for the perfect Summer Internship becomes smoother. Dive in, explore, and step into the real world with confidence and knowledge. Your future awaits, and it looks promising.';
